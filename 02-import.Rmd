...
A CJSG possui uma série de parâmetros para consulta de decisões. As mais usadas são
...
```{r}
assuntos <- readRDS("data/assuntos.rds")
classes <- readRDS("data/classes.rds")
...
```{r}
camaras <- readRDS("data/camaras.rds")
glimpse(camaras)
```
